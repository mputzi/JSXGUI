...
<div style="width:800px; background:#eeeeee; border: #999999 2px solid; padding: 3px 3px 3px 3px; margin-left:auto; margin-right:auto;">
    <div id="icons" align="left" width="100%"></div>
    <div id="box" class="jxgbox" style="width:800px; height:400px"></div>
</div>
<script type="text/javascript">
JXG.Options.board.showCopyright = true;
JXG.Options.point.showInfoBox = true;
 var board = JXG.JSXGraph.initBoard('box', {boundingbox: [-5, 2, 5, -2]});
...
class Api:
    ...
    def drawPoint(self, x=2, y=2):
        jsstring = r"var p2 = board.create('point',[" + str(x) + r"," + str(y) + r"]);"
        result = window.evaluate_js(jsstring)
#            r"""
...
if __name__ == '__main__':
    api = Api()
    window = webview.create_window('API example', html=html, js_api=api, width=1000, height=600)
    webview.start()